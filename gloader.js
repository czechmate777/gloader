// Copyright (C) 2017  czechmate777
// Inspired by jczimm: https://codepen.io/jczimm/pen/vEBpoL
$(document).ready(function(){
  ...
  $('.gloader').each(function(gi,gg){
    $(this).append('<div class="gloaderinner"><svg class="gcircular"><circle class="gpath" cx="50" cy="50" r="20" fill="none"/></svg></div>');
    $.each(this.attributes, function(ai,aa){
      if (aa.name.substr(0,13) == "data-gloader-") {
        $(gg).find(".gpath").css(aa.name.substr(13),aa.value);
      }
    });
  });
});
